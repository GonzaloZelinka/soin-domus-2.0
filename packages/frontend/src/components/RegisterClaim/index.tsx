...
const RegisterClaim = ({ inquilino, propiedad }: Props) => {
  ...
  const [claimDateStart, setClaimDateStart] = React.useState<Date>(new Date('Jul 12 1900'))
  ...
  useEffect(() => {
    const completeInformation = isMatch(
      { claimInfo, dateStart: claimDateStart },
      {
        prioridad: '',
        atencionRequerida: '',
        reclamante: '',
        descripcion: '',
        dateStart: new Date('Jul 12 1900'),
      },
    )
